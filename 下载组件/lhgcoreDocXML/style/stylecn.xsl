...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
	...
	<xsl:template match="/docs">
		...
		<head>
			...
			<title>lhgcore Mini JavaScript API中文文档 </title>
		...
		<body id="docs">
			<div id="header">
				<div id="headerMain"><strong>lhgcore Mini JavaScript Library v1.2.2</strong> API说明文档 <span style="color:#f00;font-size:11px;">Copyright lhgcore (c) 2009 All Rights Reserved</span></div>
			</div>
			<div id="wrapper">
				<div id="sidebar">

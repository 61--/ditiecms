...
namespace DTCMS.TemplateEngine
{
    ...
    public class Template : Tag
    {
        ...
        private UserDefinedFunctionCollection _UserDefinedFunctions;
        private ElementCollection<Template> _ChildTemplates;
        private Template _TagContainer;
        ...
        {
            get { return _UserDefinedFunctions; }
            private set { _UserDefinedFunctions = value; }
        }

        /// <summary>
        /// 返回此模板下的子模板元素
        /// </summary>
        public ElementCollection<Template> ChildTemplates
        {
            get { return _ChildTemplates; }
        ...
        /// 标签容器
        /// </summary>
        protected Template TagContainer
        {
        ...
        {
            get { return this.Attributes["render"]; }
        }
        ...
        {
            get { return this.Attributes["rendermethod"]; }
        }
        #endregion
        ...
        {
            get { return this.fileDependencies.ToArray(); }
        }
        /// <summary>
        /// 添加模板的依赖文件
        /// </summary>

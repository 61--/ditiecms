...
namespace DTCMS.IDAL
{
	...
	/// 接口层 IUsergroup
	/// </summary>
    public interface IDAL_Usergroup : IDAL_Base
	{
		/// <summary>
		/// 增加一条数据
		/// </summary>
		...
		List<Usergroup> GetList(out long count);
		...
		List<Usergroup> GetPageList(int pageSize, int pageIndex, out long count);
	}
}

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="class_add.aspx.cs" Inherits="DTCMS.Web.admin.Class_add" %>
                ...
                <table cellpadding="10" cellspacing="0" class="table_form">
                    <tr>
                        ...
                        <td class="main_bright split">
                            <select id="slt_ParentClassName" runat="server" onchange="trimSign(this)" style="width: 300px; background: #F7FAFC; " ></select>
                        </td>
                    </tr>
                    <tr>
                        <td class="main_bleft split">

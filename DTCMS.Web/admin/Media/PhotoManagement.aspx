...
<body>
    <form id="form1" runat="server"><div id="container">
		...
		<div id="content">
		    <div class="toolbar">
                <a href="" class="button b4"><img src="../images/ico/i_p_type.gif" alt="" />新建分类</a>
                <a href="" class="button b2"><img src="../images/ico/i_p_insert.gif" alt="" />上传</a>
                <a href="" class="button b2"><img src="../images/ico/i_p_edit.gif" alt="" />编辑</a>
                <a href="" class="button b2"><img src="../images/ico/i_p_delete.gif" alt="" />删除</a>
                <a href="" class="button b2"><img src="../images/ico/i_p_shift.gif" alt="" />转移</a>
            </div>
			<div id="gridTreeDiv">
			</div>
		</div>

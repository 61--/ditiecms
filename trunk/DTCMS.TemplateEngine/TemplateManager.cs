...
namespace Ader.TemplateEngine
{
	...
	public class TemplateManager
	{
        ...
        protected object EvalBinaryExpression(BinaryExpression exp)
        {
            switch (exp.Operator)
            {
                case Ader.TemplateEngine.Parser.TokenKind.OpOr:
                {
                ...
                case Ader.TemplateEngine.Parser.TokenKind.OpAnd:
                {
					object lhsValue = EvalExpression(exp.Lhs);
					if (!Util.ToBool(lhsValue))
						return false;
				...
				case Ader.TemplateEngine.Parser.TokenKind.OpIs:
				{
					object lhsValue = EvalExpression(exp.Lhs);
					object rhsValue = EvalExpression(exp.Rhs);
				...
				case Ader.TemplateEngine.Parser.TokenKind.OpIsNot:
				{
					object lhsValue = EvalExpression(exp.Lhs);
					object rhsValue = EvalExpression(exp.Rhs);
				...
				case Ader.TemplateEngine.Parser.TokenKind.OpGt:
				{
					object lhsValue = EvalExpression(exp.Lhs);
					object rhsValue = EvalExpression(exp.Rhs);
				...
				case Ader.TemplateEngine.Parser.TokenKind.OpLt:
				{
					object lhsValue = EvalExpression(exp.Lhs);
					object rhsValue = EvalExpression(exp.Rhs);
				...
				case Ader.TemplateEngine.Parser.TokenKind.OpGte:
				{
					object lhsValue = EvalExpression(exp.Lhs);
					object rhsValue = EvalExpression(exp.Rhs);
				...
				case Ader.TemplateEngine.Parser.TokenKind.OpLte:
				{
					object lhsValue = EvalExpression(exp.Lhs);
					object rhsValue = EvalExpression(exp.Rhs);

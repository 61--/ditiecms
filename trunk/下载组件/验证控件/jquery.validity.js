/*------------------------------------------------------------------------------
版权信息: CopyRight (C) 2004-2010 盈泰自动化科技有限公司
功能描述: jQuery表单验证插件
创建标识: LINPANXING 于 2010年07月09日 11:46:55 创建
修改描述:
修改标识: 
------------------------------------------------------------------------------*/
(function($) {
...
$.exend( $.check, {
	...
	blurchk : function()
	{
		...
		var c = $.check, msgs = c.formchk( this, r ), okmg = r.okmsg || '验证通过'; 

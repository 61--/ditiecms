...
namespace Tuan.Common
{
    public class Utils
    {
        ...
        public static StringBuilder DataTableToJson(System.Data.DataTable dt, int totalRecord)
        {
            ...
            {
                dt_field[i] = dc.Caption.ToLower();
                formatStr += "'" + dc.Caption.ToLower() + "':";
                fieldtype = dc.DataType.ToString().ToLower();
            ...
            foreach (System.Data.DataRow dr in dt.Rows)
            {
                ...
                {   //对 \ , ' 符号进行转换 
                    objectArray[i] = dr[dt_field[i]].ToString().Replace("\\", "\\\\").Replace("'", "\\'");
        ...
        public static int CityToID(string city)
        {
            switch (city)
            {
                case "": return 1;

	...
	public class Arc_ArticleDAL : BaseDAL, IDAL_Arc_Article
	{
		...
		public int Add(Arc_Article model)
		{
			...
			SqlParameter[] cmdParms = {
				...
				AddInParameter("@ShortTitle", SqlDbType.NVarChar, 25, model.ShortTitle),
				...
				AddInParameter("@Tags", SqlDbType.NVarChar, 25, model.Tags),
				AddInParameter("@ImgUrl", SqlDbType.VarChar, 255, model.ImgUrl),
				AddInParameter("@Author", SqlDbType.NVarChar, 12, model.Author),
				AddInParameter("@Editor", SqlDbType.NVarChar, 12, model.Editor),
				AddInParameter("@PubLisher", SqlDbType.NVarChar, 12, model.PubLisher),
				AddInParameter("@Source", SqlDbType.NVarChar, 25, model.Source),
				AddInParameter("@Templet", SqlDbType.VarChar, 255, model.Templet),
				AddInParameter("@Keywords", SqlDbType.NVarChar, 50, model.Keywords),
				AddInParameter("@Description", SqlDbType.NVarChar, 125, model.Description),
				AddInParameter("@AContent", SqlDbType.NVarChar, 2, model.AContent),
		...
		public int Update(Arc_Article model)
		{
			...
			SqlParameter[] cmdParms = {
				AddInParameter("@ClassID", SqlDbType.Int, 4, model.ClassID),
				AddInParameter("@ViceClassID", SqlDbType.Int, 4, model.ViceClassID),
				AddInParameter("@Title", SqlDbType.NVarChar, 12, model.Title),
				AddInParameter("@ShortTitle", SqlDbType.NVarChar, 12, model.ShortTitle),
				AddInParameter("@TitleStyle", SqlDbType.VarChar, 100, model.TitleStyle),
				AddInParameter("@TitleFlag", SqlDbType.TinyInt, 1, model.TitleFlag),
				AddInParameter("@Tags", SqlDbType.NVarChar, 12, model.Tags),
				AddInParameter("@ImgUrl", SqlDbType.VarChar, 255, model.ImgUrl),
				AddInParameter("@Author", SqlDbType.NVarChar, 6, model.Author),
				AddInParameter("@Editor", SqlDbType.NVarChar, 6, model.Editor),
				AddInParameter("@PubLisher", SqlDbType.NVarChar, 6, model.PubLisher),
				AddInParameter("@Source", SqlDbType.NVarChar, 12, model.Source),
				AddInParameter("@Templet", SqlDbType.VarChar, 255, model.Templet),
				AddInParameter("@Keywords", SqlDbType.NVarChar, 25, model.Keywords),
				AddInParameter("@Description", SqlDbType.NVarChar, 62, model.Description),
				AddInParameter("@AContent", SqlDbType.NVarChar, 1, model.AContent),
				AddInParameter("@Click", SqlDbType.Int, 4, model.Click),
				AddInParameter("@Good", SqlDbType.Int, 4, model.Good),
				AddInParameter("@Bad", SqlDbType.Int, 4, model.Bad),
				AddInParameter("@Readaccess", SqlDbType.SmallInt, 2, model.Readaccess),

...
namespace DTCMS.SqlServerDAL
{
	...
	public class Sys_DictDAL : BaseDAL, IDAL_Sys_Dict
	{
        ...
        {
            string strSql = string.Format("SELECT TOP 1 {0} FROM {1}Sys_Dict WHERE 1=1 {2}", filed, tablePrefix, where);
		...
		{
			string strSql = string.Format("SELECT {0} FROM {1}Sys_Dict WHERE 1=1 {2}", fileds, tablePrefix, where);

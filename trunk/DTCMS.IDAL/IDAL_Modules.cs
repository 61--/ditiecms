...
namespace DTCMS.IDAL
{
	...
	/// 接口层 IModules
	/// </summary>
    public interface IDAL_Modules : IDAL_Base
	{
		/// <summary>
		/// 增加一条数据
		/// </summary>
		...
		List<Modules> GetList(out long count);
		...
		List<Modules> GetPageList(int pageSize, int pageIndex, out long count);
	}
}

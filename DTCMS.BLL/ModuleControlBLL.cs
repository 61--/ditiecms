...
namespace DTCMS.BLL
{
	...
	/// 业务逻辑类 ModuleControl
	/// </summary>
	public class ModuleControlBLL
	{
		private readonly IDAL_ModuleControl dal = DataAccess.CreateFactoryDAL<IDAL_ModuleControl>("ModuleControlDAL");
		public ModuleControlBLL()
		{ }

        /// <summary>
		/// 增加一条数据
		/// </summary>
        public void Add(ModuleControl model)
        {
            dal.Add(model);
        }
		...
		/// 更新一条数据
		/// </summary>
        public void Update(ModuleControl model)
        {
            dal.Update(model);
        }

...
namespace DTCMS.SqlServerDAL
{
    ...
    public class RolesInModulesDAL : BaseDAL, IDAL_RolesInModules
    {
        ...
        {
            string strSql = string.Format("DELETE FROM {0}RolesInModules WHERE RoleID={1}", tablePrefix, roleID);
        ...
        {
            string strSql = string.Format("SELECT TOP 1 {0} FROM {1}RolesInModules {2}", filed, tablePrefix, where);
        ...
        {
            string strSql = string.Format("SELECT {0} FROM {1}RolesInModules {2}", fileds, tablePrefix, where);
        ...
        /// <returns>对象泛型集合</returns>
        private List<RolesInModules> GetList(SqlDataReader dr, out int count)
        {
            count = 0;
        ...
        private List<RolesInModules> GetPageList(SqlDataReader dr, int pageSize, int pageIndex, out int count)
        {
